          ...
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg">
            <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium mb-2 text-[#002131]">Name</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2 text-[#002131]">Email</label>
                  <input
                    type="email"
                    id="email"
                    name="email"
              ...
              <div className="mb-8">
                <label htmlFor="subject" className="block text-sm font-medium mb-2 text-[#002131]">Subject</label>
                <input
                  type="text"
                  id="subject"
                  name="subject"
              ...
              <div className="mb-8">
                <label htmlFor="message" className="block text-sm font-medium mb-2 text-[#002131]">Message</label>
                <textarea
                  id="message"
                  name="message"
