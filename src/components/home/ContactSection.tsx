    ...
    <section className="bg-[#2B2C30] section-padding">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-[#1A1A1C] p-8 rounded-2xl border border-[#F1EFE8]/20 section-animate hover:border-[#F1EFE8]/40 transition-all duration-300 group">
            <div className="bg-[#2B2C30] p-6 rounded-xl inline-block mb-6 group-hover:bg-[#F1EFE8]/10 transition-colors duration-300">
