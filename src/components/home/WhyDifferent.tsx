    ...
    <section className="bg-[#f7f7f7] section-padding">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="heading text-[#2B2C30]">What Makes Coupit Different</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <Rocket className="w-12 h-12 text-[#2B2C30]" />,
            ...
            {
              icon: <Globe className="w-12 h-12 text-[#2B2C30]" />,
            ...
            {
              icon: <DollarSign className="w-12 h-12 text-[#2B2C30]" />,
            ...
            <div 
              ...
              className="group bg-white p-8 rounded-2xl shadow-lg section-animate relative
                         ...
                         before:border-[#F1EFE8]/30 before:scale-95 before:opacity-0
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-[#2B2C30] mb-2
                               transition-transform duration-300 group-hover:translate-x-2">
                  {feature.title}
                </h3>
                <p className="text-[#44464D] font-semibold mb-4
                             transition-transform duration-300 group-hover:translate-x-2">
                  {feature.subtitle}
                </p>
