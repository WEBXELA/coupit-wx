    ...
    <section className="bg-[#f7f7f7] section-padding">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: <Rocket className="w-12 h-12 text-[#F1EFE8]" />,
            ...
            {
              icon: <Globe className="w-12 h-12 text-[#F1EFE8]" />,
            ...
            {
              icon: <DollarSign className="w-12 h-12 text-[#F1EFE8]" />,
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-[#F1EFE8] font-semibold mb-4
                             transition-transform duration-300 group-hover:translate-x-2">
                  {feature.subtitle}
                </p>
